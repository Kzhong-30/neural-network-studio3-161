...
export const useTraining = (model, networkConfig, modelType) => {
  ...
  const startTraining = useCallback(async () => {
    ...
    // Generate training data based on selected model type
    const { inputs, outputs } = generateTrainingData(modelType, 100);
