...
function App() {
  ...
  const { model, weights, createModel, updateModel } = useNeuralNetwork();
  const { training, startTraining, stopTraining, stats } = useTraining(model, networkConfig, selectedModel);

  useEffect(() => {
    createModel(networkConfig);
  }, []);
        ...
        <div className='main-content'>
          ...
          <div className='sidebar left-sidebar'>
            ...
            <div className='sidebar-section'>
              ...
              <ControlsPanel networkConfig={networkConfig} onConfigChange={handleConfigChange} onStartTraining={startTraining} onStopTraining={stopTraining} isTraining={training} />
            </div>
          </div>
          ...
          <div className='viewport'>
            ...
            <div className='visualization-container'>
              <NetworkScene networkConfig={networkConfig} weights={weights} isTraining={training} />
            </div>
          </div>
          ...
          <div className='sidebar right-sidebar'>
            ...
            <div className='sidebar-section'>
              ...
              <div className='training-controls'>
                <button className={`train-btn primary ${training ? 'active' : ''}`} onClick={startTraining} disabled={training}>
                  {training ? 'TRAINING...' : 'START TRAINING'}
                </button>
                <button className='train-btn secondary' onClick={stopTraining} disabled={!training}>
                  STOP TRAINING
                </button>
              </div>
            </div>
